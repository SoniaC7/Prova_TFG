  ...
  <div class="medium">
   ...
   <div v-show="!this.finish_level">
				...
				<div v-if="this.media_right" >
					<div class="column" >
						<img id="mediaIdMedium" :src="this.media_image" v-on:click="increment_score_win(index)"/>
					</div>
					{{ log(index) }}
					<div class="column">
						<img id="realIdMedium" :src="this.real_image" v-on:click="increment_score_lose(index)"/>
					</div>
				</div> 
...
<script>
  export default {
    ...
    data: () => ({ 
      ...
      media_image: require('../assets/images/media/medium/1/media.png'),
      real_image: require('../assets/images/media/medium/1/real.png'),
    ...
    methods:{
        ...
        reset_values(){
          this.index = 1;
          this.i_clicked= 1;
          this.total_images= 20; /*es pot posar 15 com al easy*/ 
          this.fol_name= '';
          this.score= 0;
          this.progress= 0;
          this.accuracy= 0;
          ...
          this.media_image= require('../assets/images/media/medium/1/media.png');
          this.real_image= require('../assets/images/media/medium/1/real.png');
        },
        show_badges(){
        ...
        add_border(media_clicked){
          if(media_clicked)document.getElementById("mediaIdMedium").style.border = "2px solid black" ;
          else document.getElementById("realIdMedium").style.border = "2px solid black";
        },
        remove_borders(){
          document.getElementById("mediaIdMedium").style.border = "0px solid black";
          document.getElementById("realIdMedium").style.border = "0px solid black";
        },
        ...
        getImageMedia(index){
            ...
            this.fol_name = require('../assets/images/media/medium/'+ in_string + '/media.png');
            return this.fol_name;
        },
        getImageReal(index){
            var in_string = index.toString();
            this.fol_name = require('../assets/images/media/medium/'+ in_string + '/real.png');
            return this.fol_name;
        },
        next(){
