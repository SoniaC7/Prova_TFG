  ...
  <div class="difficult">
   ...
   <div v-show="!this.finish_level">
          ...
          <div v-if="this.media_right" >
            <div class="column" >
              <img id="mediaIdDiff" :src="this.media_image" v-on:click="increment_score_win(index)"/>
            </div>
            {{ log(index) }}
            <div class="column">
              <img id="realIdDiff" :src="this.real_image" v-on:click="increment_score_lose(index)"/>
            </div>
          </div> 
